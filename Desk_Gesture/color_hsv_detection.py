...
class ColorHSVDetection:
    ...
    def __init__(self, point_number):
        ...
        self.cap.set(3,1280)
        self.cap.set(4,720)
        self.point_number = str(point_number)
        # for debug reasons
        # self.point_number = "1" 
    ...
    def main(self):
        while True:
            ...
            cv2.imshow('Trackbars2',cv2.resize(stacked,None,fx=0.4,fy=0.4))
            ...
            if key == ord('s'):
                ...
                np.save("npy-files/point_" + self.point_number, thearray)
                break
